...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("http://localhost/rezept/registration.php", {
        method: "POST",
      ...
      <div className="col-6 p-0 left-wrapper">
        <div className="mx-5 my-4 content-box">
          <div className="d-flex flex-column register-content">
            ...
            <p className="my-2">
              We will send you an SMS to verify your mobile number
            </p>
            <div className="check">
              <label>
                <input type="checkbox" />
                <span>
                  I would like to receive personalized commercial communications
                  from SUPER RECIPE by email.
                </span>
              </label>
            </div>
            <div className="check">
            ...
            <button
              type="submit"
              form="register-form"
              className="btn mt-5 btn-outline-dark "
            >
              REGISTER
            </button>
            <a
